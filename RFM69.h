...
#include <DigitalIO.h>
#include <SoftSPI.h>
const uint8_t SOFT_SPI_MISO_PIN = 16;	// choose your own MISO pin if you wish
const uint8_t SOFT_SPI_MOSI_PIN = 15;	// choose your own MOSI pin if you wish
const uint8_t SOFT_SPI_SCK_PIN  = 14;	// choose your own SCL pin if you wish
const uint8_t SPI_MODE = 0;

#define RF69_SPI_CS 17								// choose your own DATA pin if you wish
